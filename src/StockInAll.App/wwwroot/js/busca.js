        ...
        myRecognition.addEventListener('result', function (evt) {
            ...
            switch (resultSpeak.toLowerCase()) {
                case 'clarear':
                    ...
                    break;
                case 'cadastrar o produto':
                    window.location.href = "Cadastrar.html";
                    break;
                case 'nome do produto é livro':
                        document.getElementById("nomeProduto").value = "Livro";
                    break;
                case 'valor do produto é 11':
                        document.getElementById("valorProduto").value = "11";
                    break;
                case 'escurecer':
